...
//            "VirtualButtons/TextureTeapotGreen.png", getAssets()));
        mTextures.add(Texture.loadTextureFromApk("blue.png",
                getAssets()));
        mTextures.add(Texture.loadTextureFromApk("orange1.png",
                getAssets()));
        mTextures.add(Texture.loadTextureFromApk("green1.png",
                getAssets()));
        mTextures.add(Texture.loadTextureFromApk("purple1.png",
                getAssets()));
        mTextures.add(Texture.loadTextureFromApk("whiteblue1.png",
                getAssets()));
    }
