...
public class MultiTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    private CubeObject mCubeObject = new CubeObject();
    ...
    final static float kBowlScaleX = 0.03f;
    final static float kBowlScaleY = 0.03f;
    final static float kBowlScaleZ = 0.03f;
    ...
    private void animateBowl(float[] modelViewMatrix)
    {
        ...
        Matrix.rotateM(modelViewMatrix, 0, rotateAngle, 5.0f, 3.0f, 5.0f);
